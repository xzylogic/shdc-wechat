...
import classes from './EntranceComponent.scss'
...
class Index extends React.Component {
  ...
  render() {
    ...
    if (hosDeptCode == 0 && toHosDeptCode == 0) {
      entranceList = (
        <List className={classes.EntranceList}>
    ...
    const iconStyle = ['anticon', 'icon-infocirlceo', classes.Icon]

    return (
      <div>
        <WhiteSpace size='lg' />
        <WingBlank size='lg'>{entranceList}</WingBlank>
        <WhiteSpace size='lg' />
        <WingBlank size='lg'>
          <div className={classes.EntranceDesc}>
